...
const TaskCard = ({ task, onClick }) => {
    return (
        <div
            onClick={onClick}
            className="relative bg-white rounded-xl border border-gray-200 hover:scale-102 transition-all overflow-hidden cursor-pointer"
        >
            <div className="p-3">
                ...
                <div className="flex flex-row items-center justify-between">
                    ...
                    <div className="flex flex-row items-center gap-2">
                        <div className="flex flex-row items-center gap-1 text-black/40">
                            ...
                            <span className="text-[11px]">{formatDeadline(task.deadline)}</span>
                        </div>
